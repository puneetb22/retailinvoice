...
class BackupFrame(tk.Frame):
    ...
    def setup_actions_panel(self, parent):
        ...
        style = ttk.Style()
        style.configure("success.TButton", background=COLORS["success"], foreground=COLORS["text_white"], font=FONTS["regular_bold"])
        style.configure("warning.TButton", background=COLORS["warning"], foreground=COLORS["text_white"], font=FONTS["regular_bold"])
        style.configure("info.TButton", background=COLORS["info"], foreground=COLORS["text_white"], font=FONTS["regular_bold"])
        style.configure("danger.TButton", background=COLORS["danger"], foreground=COLORS["text_white"], font=FONTS["regular_bold"])
